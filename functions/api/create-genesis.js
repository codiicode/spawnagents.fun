const GENESIS_ARCHETYPES = [
  ...
  { id: "the-monk", name: "The Monk", dna: { aggression: 0.15, patience: 0.55, risk_tolerance: 0.2, focus: "memecoin", buy_threshold_holders: 600, buy_threshold_volume: 2000, sell_profit_pct: 60, sell_loss_pct: 5, max_position_pct: 25, check_interval_min: 8 } },
  { id: "the-sniper", name: "The Sniper", dna: { aggression: 0.4, patience: 0.5, risk_tolerance: 0.45, focus: "memecoin", buy_threshold_holders: 500, buy_threshold_volume: 1500, sell_profit_pct: 40, sell_loss_pct: 8, max_position_pct: 35, check_interval_min: 6 } },
  ...
  { id: "the-surgeon", name: "The Surgeon", dna: { aggression: 0.5, patience: 0.45, risk_tolerance: 0.35, focus: "memecoin", buy_threshold_holders: 400, buy_threshold_volume: 1000, sell_profit_pct: 25, sell_loss_pct: 6, max_position_pct: 35, check_interval_min: 5 } },
  ...
  { id: "the-turtle", name: "The Turtle", dna: { aggression: 0.2, patience: 0.6, risk_tolerance: 0.25, focus: "memecoin", buy_threshold_holders: 700, buy_threshold_volume: 2500, sell_profit_pct: 50, sell_loss_pct: 5, max_position_pct: 20, check_interval_min: 10 } },
  ...
  { id: "the-oracle", name: "The Oracle", dna: { aggression: 0.3, patience: 0.55, risk_tolerance: 0.3, focus: "memecoin", buy_threshold_holders: 600, buy_threshold_volume: 2000, sell_profit_pct: 55, sell_loss_pct: 6, max_position_pct: 25, check_interval_min: 7 } },
  ...
  { id: "the-colossus", name: "The Colossus", dna: { aggression: 0.55, patience: 0.4, risk_tolerance: 0.5, focus: "memecoin", buy_threshold_holders: 400, buy_threshold_volume: 1000, sell_profit_pct: 35, sell_loss_pct: 10, max_position_pct: 45, check_interval_min: 5 } }
];
export async function onRequest(context) {
  ...
  const claimed = await db.prepare("SELECT id, owner_wallet, agent_wallet, status, total_pnl, total_trades, generation FROM agents WHERE generation = 0").all();
  const claimedMap = {};
  ...
  const archetypes = GENESIS_ARCHETYPES.map(a => {
    ...
    return c
      ? { ...a, available: false, owner_wallet: c.owner_wallet, agent_wallet: c.agent_wallet, total_pnl: c.total_pnl || 0, total_trades: c.total_trades || 0, generation: c.generation || 0 }
      : { ...a, available: true };
  });
